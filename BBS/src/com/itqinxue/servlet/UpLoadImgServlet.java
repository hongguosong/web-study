...
import com.itqinxue.dao.impl.ImageDaoImpl;
...
/*                        req.setAttribute("message",
                            "文件上传成功!");*/
                        src=req.getRequestURL()+File.separator+fileName;
        ...
        Image img=new Image();
        img.setImage_desc(desc);
        img.setImage_src(src);
        ImageDaoImpl dao=new ImageDaoImpl();
        dao.addImage(img);
        
        // 跳转到 message.jsp
        getServletContext().getRequestDispatcher("/imgShow.jsp").forward(req, resp);
	}
